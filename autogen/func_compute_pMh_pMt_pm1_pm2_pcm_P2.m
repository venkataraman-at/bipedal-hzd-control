...
%%%%
pcm=zeros(2,1);
pcm(1,1) = (Mt*(l*sin(q1 + q3) - r*sin(q1)) + m*((r*sin(q1 + q2))/2 - r*sin(q1)) - Mh*r*sin(q1) - (m*r*sin(q1))/2)/(Mh + Mt + 2*m);
pcm(2,1) = -(Mt*(l*cos(q1 + q3) - r*cos(q1)) + m*((r*cos(q1 + q2))/2 - r*cos(q1)) - (m*r*cos(q1))/2 - Mh*r*cos(q1))/(Mh + Mt + 2*m);
%%%%
%%%%
P2=zeros(2,1);
