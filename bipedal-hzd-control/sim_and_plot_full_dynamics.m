...
%                   3rd to 5th Bezier coefficient for q3
%
f = [-0.1798, -0.3789, 0.2166, 0.2602, 0.3907, 3.1889, 3.2065, 3.1412];
...
poincare_analysis(x_plus0, a, s_params, 10);
...
n = 5;     % Number of desired steps the biped should take
...
%     [x_plus, ~] = func_impact_map(x_sol(end,:));
% z_plus = x_plus(end, [1,4]);
% x_plus0 = func_map_z_x(z_plus, a, [x_min, x_max]);
