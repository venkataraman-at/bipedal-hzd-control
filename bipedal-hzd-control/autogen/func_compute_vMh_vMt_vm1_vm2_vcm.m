...
%%%%
vcm=zeros(2,1);
vcm(1,1) = (dq1*(Mt*(l*cos(q1 + q3) - r*cos(q1)) + m*((r*cos(q1 + q2))/2 - r*cos(q1)) - (m*r*cos(q1))/2 - Mh*r*cos(q1)))/(Mh + Mt + 2*m) + (Mt*dq3*l*cos(q1 + q3))/(Mh + Mt + 2*m) + (dq2*m*r*cos(q1 + q2))/(2*(Mh + Mt + 2*m));
vcm(2,1) = (dq1*(Mt*(l*sin(q1 + q3) - r*sin(q1)) + m*((r*sin(q1 + q2))/2 - r*sin(q1)) - Mh*r*sin(q1) - (m*r*sin(q1))/2))/(Mh + Mt + 2*m) + (Mt*dq3*l*sin(q1 + q3))/(Mh + Mt + 2*m) + (dq2*m*r*sin(q1 + q2))/(2*(Mh + Mt + 2*m));
%%%%
%%%%
%%End of code